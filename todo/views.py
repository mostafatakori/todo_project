    ...
    if request.method=='GET':
        ...
        if request.POST['password1']==request.POST['password2']:
            try:
                ...
                return render(request, 'todo/signupuser.html', {'form': UserCreationForm(),'error':'The Username is token, Please take new username'})

        else:
                return render(request, 'todo/signupuser.html', {'form': UserCreationForm(),'error': 'Your password did not match'})
...
def createtodo(request):
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'todo/createtodo.html', {'form': TodoForm(), 'error':'This Bad data passed, Try again'})
